...
-- File explorer
vim.keymap.set("n", "<leader>cd","<cmd>Neotree toggle<CR>", { desc = "Open file explorer" })
...
--codecompanion
vim.keymap.set({ "n", "x" }, "<leader>ca", function() require("tiny-code-action").code_action() end, { noremap = true, silent = true })vim.keymap.set("n", "<leader>cp", "<cmd>CodeCompanion<CR>", { desc = "Open Code Companion" })
