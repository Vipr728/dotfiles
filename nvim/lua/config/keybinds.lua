...
-- File explorer
vim.keymap.set("n", "<leader>cd", "<cmd>Neotree right reveal toggle<CR>", { desc = "Open file explorer" })
...
-- vim-tmux-navigator handles Ctrl+h/j/k/l for split AND tmux pane navigation
